          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center animate-fade-in">
              ...
              <p className="font-inter text-lg md:text-xl text-primary-foreground/90">
                Visit our showroom or reach out to us. We're here to help you find the perfect furniture.
              </p>
            </div>
          </div>
        </section>
                ...
                <div className="space-y-6 mb-12">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+919876543210" className="font-inter text-muted-foreground hover:text-accent transition-colors">
                        +91 98765 43210
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@sardarfurniture.com" className="font-inter text-muted-foreground hover:text-accent transition-colors">
